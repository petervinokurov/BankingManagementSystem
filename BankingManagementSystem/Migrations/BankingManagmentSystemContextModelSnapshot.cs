...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaBankingManagementSystemntities.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BaBankingManagementSystemntities.BmsRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("BaBankingManagementSystemntities.BmsUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("BaBankingManagementSystemntities.Currency", b =>
                {
            ...
            modelBuilder.Entity("BaBankingManagementSystemntities.CurrencyRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BaBankingManagementSystemntities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BaBankingManagementSystemntities.Log", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BaBankingManagementSystemntities.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BaBankingManagementSystemntities.Account", b =>
                {
                    b.HasOne("BaBankingManagementSystemntities.Currency", "Currency")
                        .WithMany("Accounts")
                        .HasForeignKey("CurrencyCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BaBankingManagementSystemntities.Customer", "Customer")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("BaBankingManagementSystemntities.Transaction", b =>
                {
                    b.HasOne("BaBankingManagementSystemntities.Account", "Account")
                    ...
                    b.HasOne("BaBankingManagementSystemntities.CurrencyRate", "CurrencyOnDate")
                        .WithMany("Transactions")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("BaBankingManagementSystemntities.BmsRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("BaBankingManagementSystemntities.BmsUser", null)
                        .WithMany()
